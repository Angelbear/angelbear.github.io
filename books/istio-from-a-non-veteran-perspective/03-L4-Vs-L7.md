...
Underlying the `istio-proxy` of each client pod would calculate the 


As a beginner of Istio, I always got confused with **VirtualService** and **DestinationRule**, it seems that they have very similar settings and why Istio split them into 2 resources instead of 1 resource.
